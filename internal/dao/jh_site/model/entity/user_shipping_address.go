...
type UserShippingAddress struct {
	...
	Town      string      `json:"town"       orm:"town"       description:"区镇"`                // 区镇
	Address   string      `json:"address"    orm:"address"    description:"详细地址"`              // 详细地址
	Addressee string      `json:"addressee"  orm:"addressee"  description:"收件人"`               // 收件人
	Mobile    string      `json:"mobile"     orm:"mobile"     description:"手机号"`               // 手机号
	Phone     string      `json:"phone"      orm:"phone"      description:"固定电话"`              // 固定电话
	IsDefault int         `json:"is_default" orm:"is_default" description:"是否是默认收货地址。1=是；0=否"` // 是否是默认收货地址。1=是；0=否
