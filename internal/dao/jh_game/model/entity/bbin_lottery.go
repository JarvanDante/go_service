...
// BbinLottery is the golang structure for table bbin_lottery.
type BbinLottery struct {
	...
	GameHall    int         `json:"game_hall"    orm:"game_hall"    description:"所属厅"`                   // 所属厅
	Devicetype  int         `json:"devicetype"   orm:"devicetype"   description:"设备类型(pc=0 mobile=1)"`   // 设备类型(pc=0 mobile=1)
	Workdate    *gtime.Time `json:"workdate"     orm:"workdate"     description:""`                      //
