...
// PaymentAccount is the golang structure of table payment_account for DAO operations like Where/Data.
type PaymentAccount struct {
	g.Meta         `orm:"table:payment_account, do:true"`
	Id             any         //
	SiteId         any         //
