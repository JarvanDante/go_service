...
// WithdrawAccount is the golang structure of table withdraw_account for DAO operations like Where/Data.
type WithdrawAccount struct {
	g.Meta      `orm:"table:withdraw_account, do:true"`
	Id          any         //
	SiteId      any         //
	WithdrawId  any         // 第三方支付ID
	Gateway     any         // 支付网关
	Name        any         // 接口名称
	Domain      any         // 支付域名
	MerchantNo  any         // 商户号
