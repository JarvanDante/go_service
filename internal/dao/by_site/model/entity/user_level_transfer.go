...
type UserLevelTransfer struct {
	...
	BankType          int         `json:"bankType"          orm:"bank_type"           description:"转账类型。1=网银转账；2=微信；3=支付宝"` // 转账类型。1=网银转账；2=微信；3=支付宝
	TransferAccountId int         `json:"transferAccountId" orm:"transfer_account_id" description:"转账接口ID"`                 // 转账接口ID
