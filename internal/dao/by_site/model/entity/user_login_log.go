...
type UserLoginLog struct {
	...
	RefererUrl   string      `json:"refererUrl"   orm:"referer_url"   description:"来源网址"`               // 来源网址
	LoginUrl     string      `json:"loginUrl"     orm:"login_url"     description:"登录网址"`               // 登录网址
	LoginTime    *gtime.Time `json:"loginTime"    orm:"login_time"    description:"登录时间"`               // 登录时间
	LoginIp      string      `json:"loginIp"      orm:"login_ip"      description:"登录IP"`               // 登录IP
	LoginAddress string      `json:"loginAddress" orm:"login_address" description:"登录地址"`               // 登录地址
	...
	IsRobot      int         `json:"isRobot"      orm:"is_robot"      description:"判断是否是机器人登录。1=是；0=否"` // 判断是否是机器人登录。1=是；0=否
