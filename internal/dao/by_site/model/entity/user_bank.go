...
type UserBank struct {
	...
	CardAccount string      `json:"cardAccount" orm:"card_account" description:"银行账户名.这个应该与会员实名一致"` // 银行账户名.这个应该与会员实名一致
	CardNo      string      `json:"cardNo"      orm:"card_no"      description:"银行卡号"`              // 银行卡号
	DepositBank string      `json:"depositBank" orm:"deposit_bank" description:"开户行"`               // 开户行
	IsDefault   int         `json:"isDefault"   orm:"is_default"   description:"默认地址。1=默认，0=非默认"`   // 默认地址。1=默认，0=非默认
