...
type ActivityModule struct {
	...
	ModuleType int         `json:"moduleType" orm:"module_type" description:"活动模块类型。1=充值；2=大转盘；3=开宝箱；4=砸金蛋；5=抢红包"` // 活动模块类型。1=充值；2=大转盘；3=开宝箱；4=砸金蛋；5=抢红包
	ModuleId   int         `json:"moduleId"   orm:"module_id"   description:"活动模块ID"`                              // 活动模块ID
	ModuleName string      `json:"moduleName" orm:"module_name" description:"活动模块名称"`                              // 活动模块名称
