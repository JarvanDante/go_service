...
type Agent struct {
	...
	StatusCheck         int         `json:"statusCheck"         orm:"status_check"          description:"审核状态。0=待审核；1=通过；2=未通过"` // 审核状态。0=待审核；1=通过；2=未通过
	...
	DepositBankProvince string      `json:"depositBankProvince" orm:"deposit_bank_province" description:"开户行所在省"`                // 开户行所在省
	DepositBankCity     string      `json:"depositBankCity"     orm:"deposit_bank_city"     description:"开户行所在市"`                // 开户行所在市
